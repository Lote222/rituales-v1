      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-serif font-bold text-primary mb-2">Rituales Esotéricos</h3>
        ...
        <div className="border-t border-secondary/10 mt-8 pt-6 text-center text-muted/60">
          <p>&copy; {new Date().getFullYear()} Rituales Esotéricos. Todos los derechos reservados.</p>
