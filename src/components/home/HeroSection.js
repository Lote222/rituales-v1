...
const HeroSection = () => {
  return (
    <section className="relative flex items-center justify-center h-screen bg-background overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('/ritual_ingredients.jpg')] bg-cover bg-center opacity-15"></div>
      <div className="absolute inset-0 bg-gradient-to-t from-background via-background/70 to-transparent"></div>

      <div className="relative z-10 text-center px-4">
        <h1 className="text-5xl md:text-7xl font-serif font-extrabold text-foreground mb-6 leading-tight" style={{ textShadow: '0 2px 15px rgba(0,0,0,0.5)' }}>
